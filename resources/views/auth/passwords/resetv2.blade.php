            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('master-pegawai-reset-post', $pegawai->id) }}">
                                @method('PUT')
                                @csrf
                                <div class="row mb-3">
                                    <label class="col-md-4 col-form-label text-md-end">Pegawai</label>

                                    <div class="col-md-6">
                                        <input class="form-control" value="{{ $pegawai->name }}" id="name" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" value="{{ $pegawai->email }}" id="email" disabled>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <hr class="mt-2 mb-2">
                                <div class="d-flex justify-content-between mt-4 me-4 ms-4">
                                    <a  href="{{ route('master-pegawai.show', $pegawai->id) }}" class="btn btn-secondary">
                                       Kembali
                                    </a>
