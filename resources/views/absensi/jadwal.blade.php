                                ...
                                <tbody class="list">
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-primary" style="font-size: 12px!important"
                    ...
                    <div class="p-4 pb-0">
                        ...
                        <div class="row mt-4 mb-2">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="start_date">Start Date</label><span class="mr-4 mb-3"
                        ...
                        {{-- <div class="row mt-1 mb-2">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" name="keterangan" type="text"
                                    placeholder="Input keterangan" rows="2" value="{{ old('keterangan') }}"></textarea>
                            </div>
                        </div> --}}
                        <div class="mb-4">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 600px">
        <div class="modal-content position-relative">
            ...
            <form action="{{ route('jadwal.update', 1) }}" method="POST" id="jadwalEditForm"
                    ...
                    <div class="p-4 pb-0">
                        ...
                        <div class="row mt-4 mb-2">
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" name="start_date" id="startDateEdit" type="date"
                                    placeholder="Input Start Date" value="{{ old('start_date') }}" readonly />
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="pegawai">Pegawai</label><span class="mr-4 mb-3"
                        ...
                        {{-- <div class="row mt-1 mb-2">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" id="keteranganEdit" name="keterangan" type="text"
                                    placeholder="Input keterangan" rows="2" value="{{ old('keterangan') }}"></textarea>
                            </div>
                        </div> --}}
                        <div class="mb-4">
                    ...
                    $.ajax({
                        ...
                        , success: function(data) {
                            ...
                            data.forEach(function(jadwal) {
                                if (jadwal.user && jadwal.user.name && jadwal.shift && jadwal.shift.shift_name) {
                                    var eventColor;
                                    events.push({
